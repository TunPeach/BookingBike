...
class Successfullypage2Widget extends StatefulWidget {
  const Successfullypage2Widget({Key? key}) : super(key: key);

  @override
  _Successfullypage2WidgetState createState() =>
      _Successfullypage2WidgetState();
}

class _Successfullypage2WidgetState extends State<Successfullypage2Widget> {
