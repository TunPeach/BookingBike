...
class BookingFrom2Widget extends StatefulWidget {
  const BookingFrom2Widget({Key? key}) : super(key: key);

  @override
  _BookingFrom2WidgetState createState() => _BookingFrom2WidgetState();
}

class _BookingFrom2WidgetState extends State<BookingFrom2Widget> {
