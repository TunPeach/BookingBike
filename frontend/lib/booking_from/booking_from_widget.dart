...
class BookingFromWidget extends StatefulWidget {
  const BookingFromWidget({Key? key}) : super(key: key);

  @override
  _BookingFromWidgetState createState() => _BookingFromWidgetState();
}

class _BookingFromWidgetState extends State<BookingFromWidget> {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed('Successfullypage');
                                        },
                                        text: 'Booking',
                                        options: FFButtonOptions(
                                          width: 500,
